...
class AttackCalculatorTest : AnnotationSpec() {
    ...
    fun`test calculateEfficiency returns 2,0 when attack is efficient`() {
        ...
        val efficiency = AttackCalculator(attackingMonster, defendingMonster, dummyAttack, dummyBattleStats).calculateEfficiency()
    ...
    fun `criticalStrike is 2,0`(){
        val attackingMonster = dummyMonster4
        val defendingMonster = dummyMonster1
        val result = AttackCalculator(attackingMonster, defendingMonster, dummyAttack, dummyBattleStats).calculateCriticalStrike{0.05}
    ...
    fun `criticalStrike is 1,0`(){
        val attackingMonster = dummyMonster4
        val defendingMonster = dummyMonster1
        val result = AttackCalculator(attackingMonster, defendingMonster, dummyAttack, dummyBattleStats).calculateCriticalStrike{0.03}
    ...
    fun `criticalStrike is set to random`(){
        val attackingMonster = dummyMonster4
        val defendingMonster = dummyMonster1
        val result = AttackCalculator(attackingMonster, defendingMonster, dummyAttack, dummyBattleStats).calculateCriticalStrike()
